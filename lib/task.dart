  ...
  static Task? getTask(String taskId) => switch (taskId) {
    ...
    "⭐" => Task(
      ...
      clues: [
        ...
        ClueTimeLock("Star-Sirius.png", "U", 10, 20),
        ClueTimeLock("Star-Mars.png", "I", 10, 20),
        ClueTimeLock("Star-Pluto.png", "E", 10, 20),
        ClueTimeLock("Star-Saturn.png", "R", 10, 20),
        ClueTimeLock("Star-AlphaCentauri.png", "C", 10, 20),
        ClueTimeLock("Star-Alnilam.png", "L", 10, 20),
        ClueTimeLock("Star-Adromeda.png", "F", 10, 20),
